...
EmployeeSchema.virtual('fullname')
  ...
  .set(function(value){
    //optionally - split string to assign to firstname and lastname
...
EmployeeSchema.static('getEmployeeByFirstName', async function(value){
...
EmployeeSchema.query.byFirstName = function(value){
  return this.where({ firstname: new RegExp(value, 'i') });
};
