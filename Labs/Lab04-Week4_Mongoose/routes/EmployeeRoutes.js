...
//Read By ID
//test URL - http://localhost:8081/employee?id=60174acfcde1ab2e78a3a9b0
app.get('/employee', async (req, res) => {

  // const employees = await employeeModel.find({_id: req.query.id}); // shows an array of objects
  // const employees = await employeeModel.findById(req.query.id); // single document object
...
app.get('/employees/firstname/:name', async (req, res) => {
  ...
  // const employees = await employeeModel.find({firstname : new RegExp(name, 'i')}); // 'i' for case insensitive search
